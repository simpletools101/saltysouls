...
import { IResources, IResourcesContext } from "../../../../services/api/resourcesContext";
import { map } from "lit/directives/map.js";
import { createRef, ref } from "lit/directives/ref.js";
import { formatDateToReadable } from "../../../../utils/dateTimeM";
import { createComment } from "../../../../services/api/graphql/comments/createComment";
import { publishComment } from "../../../../services/api/graphql/comments/publicComment";
                ...
                (v) => {
                    publishComment(v.createComment.id).then(
                        () => {
                            ...
                            this.sendComentResult("Thank you For your Reply!", "success");
                        },
                        () => {
                            this.sendComentResult("Something Wen Wrong, Try Again!", "error");
                        }
                    );
                },
                () => {
                    ...
                    () => {
                        return html`
                            <div class="title-section">
                                <div class="wrapper">COMMENTS (${this.commentItems.length})</div>
                            </div>
                        `;
                    },
                    () => {
                ...
                <div class="comments-container">
                    <div class="wrapper">
                        ${map(this.commentItems, (item) => {
                            return html`
                                <xf-comment-item
                                    .imgSource=${this.resourcesContext.imageSources.commentsUserImage}
                                    .userName=${item.name}
                                    .comment=${item.comment}
                                    .dateCreated=${formatDateToReadable(item.createdAt)}
                                ></xf-comment-item>
                            `;
                        })}
                    </div>
