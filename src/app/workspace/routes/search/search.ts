...
import { SearchTerm } from "../../../lib/services/graphql/search/searchTerm";
    ...
    private createSlateTextUI() {
        ...
        if (this.didMakeInitialRequest) {
            if (this.noResultsFound) {
                ...
                _finalValue = `${this.searchResults.length} result${
                    this.searchResults.length > 1 ? "s" : ""
                }
                for "${
                    this._registeredSearchQuery.length > 0
                        ? this._registeredSearchQuery
                        : "Unknown Entry"
                }"`;
            }
                    ...
                    <div class="search-aux-section">
                        ...
                        <div class="search-container">
                            <div id="searchItem">
                                ...
                                <xf-make-button
                                    style=${styleMap({
                                        display: this.isCancelBtnVisible
                                            ? "flex"
                                            : "none",
                                    })}
                            ...
                            <xf-make-button
                                class="search-btn-magnifyer"
                                @xf-key-tap=${this.getSearchResults}
                            >
                                <iconify-icon
